      ...
      <div className="container-custom">
        ...
        <div className="project-featured">
          ...
          <div className="project-content">
            ...
            <a
              href="https://github.com/Shivansh-3010/AquaVerse-AI"
              target="_blank"
        ...
        <div className="projects-grid">
          ...
          <div className="project-card">
            ...
            <div className="project-card-content">
              ...
              <a
                href="https://github.com/Shivansh-3010/BoneFractureClassification"
                target="_blank"
                className="project-btn"
              >
                View Project
          ...
          <div className="project-card">
            ...
            <div className="project-card-content">
              ...
              <a
                href="https://github.com/Shivansh-3010/Ai-ChatBot"
                target="_blank"
                className="project-btn"
              >
                View Project
        ...
        <div className="project-featured dashboard-card">
          ...
          <div className="project-content">
            ...
            <a
              href="https://github.com/Shivansh-3010/Coffee-Chain-Dashboard"
              target="_blank"
              className="project-btn"
            >
              View Project
